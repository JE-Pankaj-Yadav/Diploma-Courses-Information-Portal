...
<html lang="en">
<head>
    <title>DIPLOMA IN BIO TECHNOLOGY (TISSUE CULTURE)</title>
                    ...
                    <div class="row">
                        <div class="col-9 col-lg-3">
                            <div class="site-branding">
                                <h1 class="site-title"><a href="./DIPLOMA%20IN%20BIO%20TECHNOLOGY.php" rel="home">Pan<span>kaj</span></a></h1>
                            </div><!-- .site-branding -->
                        </div><!-- .col -->
                ...
                <div class="row">
                    <div class="col-12">
                        <header class="entry-header">
                            <h1 class="entry-title">DIPLOMA IN BIO TECHNOLOGY (TISSUE CULTURE)</h1>
        ...
        <div class="row">
            <div class="col-12 offset-lg-1 col-lg-10">
                <div class="featured-image">
                    <a href="DIPLOMA_IN_BIO_TECHNOLOGY_(TISSUE CULTURE).pdf" target="_thapa"><img src="pimages/c2.jpg" alt=""></a>
                </div>
            </div><!-- .col -->
        </div><!-- .row -->
                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="foot-about">
                            <h1 class="sita-title"><a href="./DIPLOMA%20IN%20BIO%20TECHNOLOGY.php" rel="home">Pan<span>kaj</span></a></h1>
